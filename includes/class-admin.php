...
class EBI_Admin {
	...
	public function render_settings_page() {
		...
		<nav class="nav-tab-wrapper">
			<a href="<?php echo esc_url( add_query_arg( array( 'page' => 'ebi-settings-page', 'tab' => 'license' ), admin_url( 'admin.php' ) ) ); ?>" 
			   class="nav-tab <?php echo 'license' === $current_tab ? 'nav-tab-active' : ''; ?>">
				<?php esc_html_e( 'License', 'elementor-bulk-importer' ); ?>
				<?php if ( EBI_PRO_VERSION ) : ?>
					<span style="color: #46b450; margin-left: 5px;">✓</span>
				<?php endif; ?>
			</a>
			...
			<a href="<?php echo esc_url( add_query_arg( array( 'page' => 'ebi-settings-page', 'tab' => 'support' ), admin_url( 'admin.php' ) ) ); ?>" 
			   class="nav-tab <?php echo 'support' === $current_tab ? 'nav-tab-active' : ''; ?>">
				<?php esc_html_e( 'Support & About', 'elementor-bulk-importer' ); ?>
			</a>
		</nav>
			
			<?php if ( 'license' === $current_tab ) : ?>
				<?php EBI_License_Admin::render_license_tab(); ?>
			<?php elseif ( 'support' === $current_tab ) : ?>
	...
	private function render_support_tab() {
		...
		<div class="ebi-support-content" style="max-width: 800px; margin: 20px 0;">
			<div class="ebi-support-box" style="background: #fff; padding: 30px; border: 1px solid #ddd; border-radius: 8px; margin-bottom: 20px;">
				<h2 style="margin-top: 0; color: #2271b1;"><?php esc_html_e( 'Upgrade to PRO Version', 'elementor-bulk-importer' ); ?></h2>
				<p style="font-size: 16px; line-height: 1.6;"><?php esc_html_e( 'Unlock powerful translation features with PRO version!', 'elementor-bulk-importer' ); ?></p>
				
				<h3><?php esc_html_e( 'PRO Features:', 'elementor-bulk-importer' ); ?></h3>
				<ul style="font-size: 15px; line-height: 1.8; list-style-type: disc; padding-left: 20px;">
					<li><?php esc_html_e( 'Automatic Translation - Translate templates during import', 'elementor-bulk-importer' ); ?></li>
					<li><?php esc_html_e( '5 Translation APIs - MyMemory, LibreTranslate, DeepL, Microsoft, Yandex', 'elementor-bulk-importer' ); ?></li>
					<li><?php esc_html_e( '70+ Languages Support - English, Turkish, German, French, Spanish, Italian, Portuguese, Russian, Arabic, Chinese, Japanese, Korean, Hindi and many more', 'elementor-bulk-importer' ); ?></li>
					<li><?php esc_html_e( 'Smart Content Detection - Preserves Elementor structure while translating', 'elementor-bulk-importer' ); ?></li>
					<li><?php esc_html_e( 'Priority Support - Get help directly from developer', 'elementor-bulk-importer' ); ?></li>
					<li><?php esc_html_e( 'Lifetime Updates - All future updates included', 'elementor-bulk-importer' ); ?></li>
				</ul>
				
				<a href="https://t.me/bayramsavluk" target="_blank" class="button button-primary button-hero" style="margin-top: 20px; padding: 12px 30px; font-size: 16px; height: auto;">
					<?php esc_html_e( 'Contact for PRO Version', 'elementor-bulk-importer' ); ?> →
				</a>
			</div>
			...
			<div class="ebi-support-box" style="background: #fff; padding: 30px; border: 1px solid #ddd; border-radius: 8px;">
				<h2 style="margin-top: 0;"><?php esc_html_e( 'Support & Documentation', 'elementor-bulk-importer' ); ?></h2>
				<p><?php esc_html_e( 'Need help? Contact us:', 'elementor-bulk-importer' ); ?></p>
				<ul style="font-size: 15px; line-height: 1.8; list-style-type: disc; padding-left: 20px;">
					<li><strong><?php esc_html_e( 'Telegram:', 'elementor-bulk-importer' ); ?></strong> <a href="https://t.me/bayramsavluk" target="_blank">t.me/bayramsavluk</a></li>
					<li><strong><?php esc_html_e( 'Website:', 'elementor-bulk-importer' ); ?></strong> <a href="https://bayramsavluk.com" target="_blank">bayramsavluk.com</a></li>
					<li><strong><?php esc_html_e( 'Documentation:', 'elementor-bulk-importer' ); ?></strong> <a href="https://github.com/bayramsavluk/elementor-page-builder-assistant" target="_blank">GitHub Repository</a></li>
				</ul>
			</div>
		</div>
		<?php
				...
				<div class="ebi-form-group" style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #ddd;">
					<?php if ( ! EBI_PRO_VERSION ) : ?>
						<div style="background: #f0f6fc; border: 1px solid #0073aa; border-radius: 4px; padding: 15px; margin-bottom: 15px;">
							...
							<a href="https://t.me/bayramsavluk" target="_blank" class="button button-primary">
