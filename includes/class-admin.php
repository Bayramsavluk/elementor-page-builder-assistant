...
class EBI_Admin {
	...
	public function render_pages_page() {
		...
		<ul class="subsubsub">
			...
			?>
			<div id="ebi-add-page-modal" class="ebi-modal" style="display:none;" data-enabled-apis="<?php echo esc_attr( wp_json_encode( $enabled_apis_pages ) ); ?>">
	...
	public function add_header_footer_modal() {
		...
		<div id="ebi-add-hf-modal" class="ebi-modal" style="display:none;">
			<div class="ebi-modal-content ebi-modal-large" style="max-width: 1200px;">
