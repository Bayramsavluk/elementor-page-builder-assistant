...
class EBI_API {
	...
	public function get_templates() {
		...
		if ( ! current_user_can( 'manage_options' ) ) {
			wp_send_json_error( array( 'message' => __( 'You do not have permission.', 'ea-page-builder-assistant' ) ) );
		}
	...
	public function import_pages() {
		...
		if ( empty( $pages ) || ! is_array( $pages ) ) {
			wp_send_json_error( array( 'message' => __( 'Please add at least one page.', 'ea-page-builder-assistant' ) ) );
		}
	...
	public function import_single_page() {
		...
		if ( empty( $title ) || empty( $template ) ) {
			wp_send_json_error( array( 'message' => __( 'Please fill in all fields.', 'ea-page-builder-assistant' ) ) );
		}
		...
		if ( $translation_enabled ) {
			...
			wp_send_json_error( array( 'message' => __( 'Translation is a PRO feature. Please upgrade to use translation. Contact: https://t.me/bayramsavluk', 'ea-page-builder-assistant' ) ) );
		}
