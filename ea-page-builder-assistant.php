<?php
/**
 * Plugin Name: EA Page Builder Assistant
 ...
 * Text Domain: ea-page-builder-assistant
    ...
    function ebi_fs() {
        ...
        if ( ! isset( $ebi_fs ) ) {
            ...
            $ebi_fs = fs_dynamic_init( array(
                'id'                  => '21947',
                'slug'                => 'ea-page-builder-assistant',
                'type'                => 'plugin',
...
class Elementor_Bulk_Importer {
	...
	public function elementor_missing_notice() {
		$message = sprintf(
			esc_html__( 'EA Page Builder Assistant requires %s to be installed and activated.', 'ea-page-builder-assistant' ),
			'<strong>' . esc_html__( 'Elementor', 'ea-page-builder-assistant' ) . '</strong>'
		);
	...
	public function add_settings_link( $links ) {
		$settings_link = '<a href="' . esc_url( admin_url( 'admin.php?page=ebi-settings' ) ) . '">' . esc_html__( 'Settings', 'ea-page-builder-assistant' ) . '</a>';
