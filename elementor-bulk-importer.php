...
class Elementor_Bulk_Importer {
	...
	private function init() {
		...
		// Load License System (must be loaded before PRO check)
		require_once EBI_DIR . 'includes/class-license.php';
		
		// Define PRO version constant after license system is loaded
		if ( ! defined( 'EBI_PRO_VERSION' ) ) {
			define( 'EBI_PRO_VERSION', ebi_check_license() );
		}
	...
	public function add_settings_link( $links ) {
		...
		if ( ! EBI_PRO_VERSION ) {
			$upgrade_link = '<a href="https://t.me/bayramsavluk" target="_blank" style="color:#46b450;font-weight:bold;">' . esc_html__( 'Upgrade to PRO', 'elementor-bulk-importer' ) . '</a>';
